#
#  Be sure to run `pod spec lint HWPhotoPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yellowei/HWPhotoPicker"
  ...
  s.source       = { :git => "https://github.com/yellowei/HWPhotoPicker.git", :tag => s.version}
